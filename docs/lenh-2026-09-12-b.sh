...
elif grep -q "LENH B" index.js; then echo "DỪNG: index.js đã có marker LENH B nhưng thiếu _lb_backup_ts (không biết bản gốc) — khôi phục từ .bak-<TS gốc> hoặc gửi em output"; exit 1
else TSB=$TS
