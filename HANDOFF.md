...
- **FE:** zip mới nhất cần deploy = **v119-64** (07/09 chiều: = v119-60 + đợt sửa UI "hết mùi vibe code" + font Plus Jakarta Sans/Be Vietnam Pro — mục ★ v119-61 → v119-64 CLAUDE.md; tái lập: `docs/fe-2026-09-07-v119-61/README.md`). Bản riêng **v120-esm-n** (ES module) deploy sau khi v119-64 ổn.
