...
#   → backup .bak-<TS> → patch fail-closed NGUYÊN TỬ (80 mốc, đủ 7 file mới ghi) → node --check → Rules → import test (.env) → deploy 8 function + rules (xích &&) → tagLeadBrand (codebase2, lỗi = cảnh báo)
set -o pipefail
