...
- **Backend 06/09 — LỆNH #33 CHỜ ANH CHẠY (`docs/lenh-2026-09-06-33.md`)**: bỏ opt-out mặc định (content.js) + `_l33_optout.mjs` xoá ở brand/thread/task đang xếp hàng + deploy `genContent,outreachTick`. Sau khi chạy: check output.
