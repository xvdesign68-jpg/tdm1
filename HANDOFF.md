...
- **FE:** zip mới nhất cần deploy = **v119-63** (07/09 chiều: = v119-60 + đợt sửa UI "hết mùi vibe code" — mục ★ v119-61 CLAUDE.md; tái lập: `docs/fe-2026-09-07-v119-61/README.md`). Bản riêng **v120-esm-m** (ES module) deploy sau khi v119-63 ổn.
