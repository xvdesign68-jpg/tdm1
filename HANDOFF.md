...
3. ☐ **Zip frontend MỚI NHẤT** = `smartleads17deploy-v119-50.zip` (= v119-49 + thẻ ⛔ BrightData ngưng + chip thanh nhịp quét + ô "Nhịp gieo mỗi nguồn"; smoke 79/79). Trước đó v119-49 (= v119-48 + NHÓM 3: wizard "Thêm brand mới" + Bảng brand agency + LỆNH #17 daily_stats; trước đó v119-48 = v119-47 + thông báo đứng lại/nút Mở lead/rung + D.cfg; v119-47 = v119-46 + tự đăng ký lại listener sau lỗi kênh; v119-46 = v119-45 + thông báo hệ thống khi tab không focus; v119-45 = v119-44 + enablePush bền hơn; v119-44 = v119-43 + VAPID_KEY; trước đó `smartleads17deploy-v119-43.zip` (đã gửi anh 04/09 — v119-42 (việc nhỏ + Đợt 3 FE) + PWA/sw.js/manifest + thanh tab dưới + push FCM FE + badge Safety Score). Worker mới nhất `worker.mjs 2026-09-04b`. Đây là snapshot source đầy đủ, phiên mới giải nén ra là sửa được ngay.
...
- **Backend 05/09 — LỆNH #23 (`docs/lenh-2026-09-05-scheduledscan-7.md`) ĐÃ SOẠN, CHỜ ANH CHẠY**: v-sowc gieo/gặt snapshot COMMENT cho quét theo lịch (hết chờ `bdWait` 510 s) + Rules `system_status` read super. Đã test cục bộ (harness 10/10 + 8/8, dry-run script 2 lần). Sau khi chạy: deploy `scheduledScan,manualScan` rev mới + Rules; KHỐI 2 kiểm sau ≥10′.
