...
- **Code app THẬT KHÔNG nằm trong git.** Anh phải **đưa lại 3 thứ** cho phiên mới: (1) **zip frontend mới nhất `smartleads17deploy-v119-88.zip`** (+ bản riêng `v120-esm-al`), (2) **`worker.mjs` bản `2026-09-11`**, (3) `config.json` của worker. Gói **`smartlead-handoff-2026-09-11.zip`** (em gửi 11/09 sáng) chứa bản CŨ HƠN 1 nấc (v119-87 / 06d) — zip v119-88 + worker 2026-09-11 gửi rời 11/09 chiều, ưu tiên bản mới; docs/ trong git luôn mới nhất.
...
2. **Deploy zip v119-88** (Cmd+Shift+R; v119-87 bỏ qua) rồi bản riêng `v120-esm-al`; hỏi anh bố cục ROI super (v119-87) có ưng không.
