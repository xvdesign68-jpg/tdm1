...
3. ☐ **Zip frontend MỚI NHẤT** = `smartleads17deploy-v119-40b.zip` (đã gửi anh 03/09 — Đợt 1 + chỉnh: bỏ thanh liên hệ ở feed, bỏ nút bước kế). Đây là snapshot source đầy đủ, phiên mới giải nén ra là sửa được ngay.
...
- **FE:** zip mới nhất cần deploy = **v119-40b** (Đợt 1: số thật, Hôm nay, Hộp việc, Gọi·Zalo·SMS, tìm SĐT, chốt/không thành, modal mới, pipeline mobile, lead cũ realtime, Dừng tất cả).
