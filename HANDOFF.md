...
- **FE (đề xuất chờ chốt):** `v119-66` / `v120-esm-p` = v119-65 + font Geist (`docs/font-research-2026-09-07/`, `m9.py`) — anh chưa chốt.
- **FE:** zip mới nhất cần deploy = **v119-65** (07/09 tối: = v119-60 + đợt sửa UI "hết mùi vibe code" + font Plus Jakarta Sans/Be Vietnam Pro + tự kết nối lại kênh realtime — mục ★ v119-61 → v119-65 CLAUDE.md; tái lập: `docs/fe-2026-09-07-v119-61/README.md`). Bản riêng **v120-esm-o** (ES module) deploy sau khi v119-65 ổn.
...
1. Deploy zip **v119-65** (hoặc chốt font → v119-66); sau đó bản ES module tương ứng (v120-esm-o/p).
