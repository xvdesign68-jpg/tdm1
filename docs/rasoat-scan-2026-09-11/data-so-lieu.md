...
> **ĐÍNH CHÍNH 11/09 tối (critic)**: `lib/config.js` ĐÃ map `BROWSER_SVC_URL/SECRET` từ LỆNH #32 (06/09) — câu "chưa map" ở mục B là cũ. Whitelist Rules #8 (31 field) KHÔNG có `phone`, `phone_has_zalo`, `dropped_reason`, `ai_feedback` (đối chiếu `docs/lenh-2026-09-04-backend-v119-42.md:37`).
