...
3. ☐ **Zip frontend MỚI NHẤT** = `smartleads17deploy-v119-61.zip` (= v119-60 + đợt sửa UI "hết mùi vibe code" trọn 3 đợt: menu 4 nhóm tên Việt, gỡ Tích hợp/hotline/khối demo, Bảng điều khiển sắp lại + dải trạng thái, errMsg + hộp thoại app, hết chữ kỹ thuật/ALL-CAPS, 203 emoji → SVG, menu ⋯, bóng cuộn bảng, KPI 2 cột mobile, :root duy nhất + bỏ Google Fonts + dọn CSS chết; mascot giữ nguyên; smoke 108/108 — mục ★ v119-61 CLAUDE.md). Bản riêng `smartleads17deploy-v120-esm-k.zip` (ES module, cùng thay đổi) deploy sau khi v119-61 ổn.
...
- **FE:** zip mới nhất cần deploy = **v119-61** (07/09 chiều: = v119-60 + đợt sửa UI "hết mùi vibe code" — mục ★ v119-61 CLAUDE.md; tái lập: `docs/fe-2026-09-07-v119-61/README.md`). Bản riêng **v120-esm-k** (ES module) deploy sau khi v119-61 ổn.
