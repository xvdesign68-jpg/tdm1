...
- **FE — ANH ĐÃ CHỐT FONT 08/09:** `v119-67` / `v120-esm-q` = v119-65 + menu Jakarta in đậm + nội dung TikTok Sans (`m10.py`); v119-66 / v120-esm-p (Geist, `m9.py`) là bản đề xuất KHÔNG chọn. Trang xem thử 9 phương án font: artifact https://claude.ai/code/artifact/03a05b86-b756-4a95-8098-73fc5e9b49d9 (dựng tĩnh từ dữ liệu mẫu).
- **FE:** zip mới nhất cần deploy = **v119-67** (08/09: = v119-65 + font anh chốt); trước đó **v119-65** (07/09 tối: = v119-60 + đợt sửa UI "hết mùi vibe code" + font Plus Jakarta Sans/Be Vietnam Pro + tự kết nối lại kênh realtime — mục ★ v119-61 → v119-65 CLAUDE.md; tái lập: `docs/fe-2026-09-07-v119-61/README.md`). Bản riêng **v120-esm-o** (ES module) deploy sau khi v119-65 ổn.
...
1. Deploy zip **v119-67** (font anh chốt 08/09); sau đó bản ES module tương ứng **v120-esm-q**.
